...
import {AsgardeoJavaScriptClient, StorageManager, TokenConstants} from '@asgardeo/javascript';

import {AuthenticationHelper} from '../helpers/authentication-helper';
import {MainThreadClientConfig, WebWorkerClientConfig} from '../models/spa-client-config';

export class SPAHelper<T extends MainThreadClientConfig | WebWorkerClientConfig> {
  private _authenticationClient: AsgardeoJavaScriptClient<T>;
  private _storageManager: StorageManager<T>;
  private _isTokenRefreshLoading: boolean = false;

  public constructor(authClient: AsgardeoJavaScriptClient<T>) {
