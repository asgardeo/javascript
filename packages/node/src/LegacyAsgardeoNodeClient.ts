...
import {AsgardeoNodeCore} from './AsgardeoNodeCore';
...
export class AsgardeoNodeClient<T> {
  ...
  /**
   * This method can be used to update the configurations passed into the constructor of the AsgardeoJavaScriptClient.
