...
const translations: I18nTranslations = {
  ...
  'errors.signin.redirect.uri.mismatch': 'రీడైరెక్ట్ URI "{url}" ఈ అప్లికేషన్ కోసం నమోదు కాలేదు. దీన్ని కన్సోల్‌లో అప్లికేషన్ యొక్క అధీకృత రీడైరెక్ట్ URLలకు జోడించండి; మీరు యాప్-నేటివ్ సోషల్ సైన్-ఇన్ ఉపయోగిస్తే మీ సోషల్ లాగిన్ ప్రొవైడర్‌కు కూడా జోడించండి.',
