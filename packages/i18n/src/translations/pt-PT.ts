...
const translations: I18nTranslations = {
  ...
  'errors.signin.redirect.uri.mismatch': 'O URI de redirecionamento "{url}" não está registado para esta aplicação. Adicione-o aos URLs de redirecionamento autorizados da aplicação na consola e, se utilizar início de sessão social nativo, também ao seu fornecedor de início de sessão social.',
